...
public class ExtractTest {
    ...
    private static final Tweet tweet3 = new Tweet(3, "naema", "I am tired", d3);
    private static final Tweet tweet4 = new Tweet(4, "Ramlah", "@testing4 Check?",d4);
    private static final Tweet tweet5 = new Tweet(5, "bia", "@testing4 @testing5 check",d5);
    private static final Tweet tweet6 = new Tweet(6, "Farhana", "@testing4 @testing4 check",d6);
    ...
    public void testGetMentionedUsersOneMentionOneTweet() {         
        ...
        assertTrue(mentionedUsersLowerCase.contains("testing4"));
    }
    ...
    public void testGetMentionedUsersTwoeMentionOneTweet() {         
        ...
        assertTrue(mentionedUsersLowerCase.containsAll(Arrays.asList("testing4", "testing5")));
    }
